    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AttorneyAdmissionDate = table.Column<string>(type: "text", nullable: false),
                AdvocateAdmissionDate = table.Column<string>(type: "text", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                CostPerHour = table.Column<decimal>(type: "numeric", nullable: true),
                DayFeeAmount = table.Column<decimal>(type: "numeric", nullable: true),
                IsDayFee = table.Column<bool>(type: "boolean", nullable: false),
                UserId = table.Column<Guid>(type: "uuid", nullable: false),
                Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                LastModified = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
