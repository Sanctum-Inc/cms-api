...
public class
    GetCaseNumbersQueryHandler : IRequestHandler<GetCaseNumbersQuery, ErrorOr<IEnumerable<CourtCaseNumberResult>?>>
{
    ...
    public Task<ErrorOr<IEnumerable<CourtCaseNumberResult>?>> Handle(GetCaseNumbersQuery request,
